...
/// <summary>
/// One user-configurable AI skills template selectable in "Use AI to answer" mode: a
...
/// user keep several skills presets (e.g. "Translate to Korean", "Describe") and pick
/// one before capturing.
/// </summary>
public sealed class AiSkillsTemplate
{
    ...
    /// <summary>Optional MCP tool servers made available to the model for these skills.</summary>
